var $ = jQuery;
(function ($) {
    $.fn.NepaliCalendar = function (attributes) {
        $.each($(this), function () {
            //$.eac($(this),function(){
            var $selector = $(this);
            var Lang;
            ...
            var self = {
                ...
                CreateCalenderElement: function () {
                    ...
                    var Element = '<div class="NepaliCalendarElement noselect">';

                    Element += '<table id="NepaliCalendar">';

                    Element += '<thead><tr style="background:#ca4e4e; color:#fff;"><th class="noselect Prev">' + PatroLang.Prev + '</th><th data-date="' + self.GlobalDate + '" colspan="5" class="PatroCenter CurrentDateAndMonth noselect">' + PatroLang.CurrentYear + ' ' + PatroLang.CurrentMonth + '</th><th class="noselect Next">' + PatroLang.Next + '</th> </tr>';

                    Element += '<tr style="background:#ca4e4e; color:#fff;" ><th>' + PatroLang.FirstDay + '</th><th>' + PatroLang.SecondDay + '</th><th>' + PatroLang.ThirdDay + '</th><th>' + PatroLang.FourthDay + '</th><th>' +
                ...
                populateMonth: function ($date, Language) {
                    ...
                    if (GlobalObj) {
                        ...
                        $patroBody = $selector.find('#NepaliCalendar tbody');
                        //$patroBody = $('body').find(selector + ' #NepaliCalendar tbody');
                    ...
                    for (i = 0; i < 6; i++) {
                        ...
                        for (j = 0; j < 7; j++) {
                            ...
                            if (PatroDay == (days + 1)) {
                                ...
                                var selectedDateArray = $selector.find('table#NepaliCalendar thead tr:first-child th:nth-child(2)').attr('data-date').split('/');
                    ...
                    if (GlobalObj) {
                        ...
                        $(GlobalObj).closest('#NepaliCalendar').find('.CurrentDateAndMonth').html(PatroLang.CurrentYear + ' ' + PatroLang.CurrentMonth);
            ...
            // $('body').on('click', selector + ' #NepaliCalendar .Prev', function () {
            $selector.on('click', '#NepaliCalendar .Prev', function () {
                ...
                $.each($(this).closest('.NepaliCalendarElement'), function () {
            ...
            //$('body').on('click', selector + ' #NepaliCalendar .Next', function () {
            $selector.on('click', '#NepaliCalendar .Next', function () {
            ...
            $.each($('.NepaliCalendarElement'), function () {
            ...
            $('body').on('mouseover', '.NepaliCalendarElement table tbody td:not(.NepaliCalendarElement table tbody td:empty)', function (event) {
            ...
            $('body').on('mouseleave', '.NepaliCalendarElement table tbody td:not(.NepaliCalendarElement table tbody td:empty)', function (event) {
...
$(function () {
    ...
    jQuery('.NepaliCalendar').NepaliCalendar({});
