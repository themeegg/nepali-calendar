...
/**
 * NC_Admin_Assets Class.
 */
class NC_Admin_Assets
{

    /**
     * Contains an array of script handles registered by NC.
     * @var array
     */
    ...
    /**
     * Contains an array of script handles localized by NC.
     * @var array
     */
    ...
    {
        return str_replace(array('http:', 'https:'), '', plugins_url($path, NC_PLUGIN_FILE));
    }
    ...
    public static function load_scripts()
    {
        ...
        if (in_array($screen_id, nc_get_screen_ids())) {


            //if (in_array(nc_get_current_section(), array('', 'trends')) && nc_get_current_tab() == 'layouts') {
