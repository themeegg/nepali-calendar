...
class NC_Query {
	...
	public function get_endpoint_title( $endpoint ) {
		...
		switch ( $endpoint ) {
			case 'order-pay' :
				$title = __( 'Pay for order', 'nepali-calendar' );
				break;
		...
		return apply_filters( 'nepali_calendar_endpoint_' . $endpoint . '_title', $title, $endpoint );
	}
	...
	public function get_endpoints_mask() {
		if ( 'page' === get_option( 'show_on_front' ) ) {
			...
			$myaccount_page_id = get_option( 'nepali_calendar_myaccount_page_id' );
			$checkout_page_id  = get_option( 'nepali_calendar_checkout_page_id' );
	...
	public function get_query_vars() {
		return apply_filters( 'nepali_calendar_get_query_vars', $this->query_vars );
	}
